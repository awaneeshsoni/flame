        ...
        <div className="bg-black min-h-screen flex flex-col"> 
            <div className="max-w-xl mx-auto p-6 text-white">
                ...
                <div className="mt-8 bg-zinc-800 p-6 rounded-md border border-zinc-700">
                    ...
                    <p><span className="text-white/60">Current Plan:</span> <strong className="capitalize">{user.plan}</strong></p>
                    <p><span className="text-white/60">Activated On:</span> {user.planActivatedAt ? new Date(user.planActivatedAt).toLocaleDateString() : "N/A"}</p>
                    <p><span className="text-white/60">Expires On:</span> {user.planExpiresAt ? new Date(user.planExpiresAt).toLocaleDateString() : "N/A"}</p>
                </div>
            </div>
            <Footer />
        </div>
